...
#inputDat = ["turn on 499,499 through 500,500"]
...
for l in inputDat:
    ...
    if(instructions[0] == "turn off"):
        lightArray[int(instructions[1]):int(instructions[3]) + 1, int(instructions[2]):int(instructions[4]) + 1] = 0
        ...
        lightArray[int(instructions[1]):int(instructions[3]) + 1, int(instructions[2]):int(instructions[4]) + 1] = 1 - lightArray[int(instructions[1]):int(instructions[3]) + 1, int(instructions[2]):int(instructions[4]) + 1]
    else:
        print('error')
